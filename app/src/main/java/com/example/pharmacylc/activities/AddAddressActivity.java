    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addAddressBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String final_address = userName + " " + userCity + " " + userAddress + " " + userCode + " " + userNumber;
                            ...
                            .collection("Address").add(map).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                ...
                                public void onComplete(@NonNull Task<DocumentReference> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        startActivity(new Intent(AddAddressActivity.this,DetalheActivity.class));
                                        finish();
                                    }
                                }
                            });
                }else{
                    Toast.makeText(AddAddressActivity.this,"Por favor, preencha todos os campos.", Toast.LENGTH_SHORT).show();
                }
            }
        });
